...
import 'package:agenda_clinica/src/features/schedule/schedule_vm.dart';
import 'package:agenda_clinica/src/features/schedule/widgets/schedule_calendar.dart';
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen(scheduleVmProvider.select((state) => state.status), (_, status) {
      switch (status){
        ...
        break;
        case ScheduleStateStatus.succcess:
