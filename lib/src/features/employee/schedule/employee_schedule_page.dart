...
import 'package:agenda_clinica/src/features/employee/schedule/employee_schedule_vm.dart';
...
class _EmployeeSchedulePageState extends ConsumerState<EmployeeSchedulePage> {
  ...
  void initState() {
    ...
    dateSelect = DateTime(year, month, day, 0, 0, 0);
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    final scheduleAsync =
        ref.watch(employeeScheduleVmProvider(userId, dateSelect));
            ...
            data: (schedules) {
              return Expanded(
                ...
                onViewChanged: (viewChangedDetails) {
                  ...
                  ref
                      .read(employeeScheduleVmProvider(userId, dateSelect)
                          .notifier)
                      .changeDate(
                            ...
                            child: Center(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                      'Horários: ${dateFormat.format(calendarTapDetails.date ?? DateTime.now())}'),
                                ],
                              ),
                            ),
                          );
