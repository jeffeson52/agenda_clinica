...
import 'package:agenda_clinica/src/features/auth/register/user/user_register_vm.dart';
      ...
      ref.listen(userRegisterVmProvider, (_, state){
        switch(state){
          ...
          case UserRegisterStateStatus.success:
            Navigator.of(context).pushNamed('/auth/register/clinica');
          case UserRegisterStateStatus.error:
            Messages.showError('Erro ao registra usuário administrador', context,);
        }
      });
